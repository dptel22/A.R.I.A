"""
inference/test_inference.py — Smoke test for the A.R.I.A. detection pipeline.

Loads aria_stage1.pt, runs all images in images/ through the pipeline,
...
def main() -> None:
    model_path = Path("aria_stage1.pt")
