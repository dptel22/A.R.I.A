...
Usage:
    ...
    python -m tools.download_model --output aria_stage1.pt
    python -m tools.download_model --url https://github.com/<owner>/<repo>/releases/latest/download/aria_stage1.pt
"""
...
DEFAULT_OUTPUT = Path(os.environ.get("ARIA_MODEL_PATH", "./aria_stage1.pt"))
