...
import { BackendHealth, DLPStatus, PipelineStatus, RoadCase, Severity } from '../types';
            ...
            {loading ? (
              ...
              filteredCases.map((item) => (
                ...
                >
                  ...
                  <td className="px-4 py-4 text-slate-500 mono-text">{formatCreated(item.created)}</td>
                  <td className="px-4 py-4">
